...
local FirstToggle = MainPage.AddToggle("Fist Reach!", false, function(e)
    if e == true then
...
local FirstButton = MainPage.AddButton("Inf-Jump", function()
...
local qtotp = MainPage.AddButton("T to TP", function()
